...
const buildRecipeChatPrompt = (
    ...
    const lines: string[] = [
        ...
        "If the user asks you to CHANGE this recipe into a new version — substitute/add/remove ingredients, adapt it for a diet, scale the servings, change the difficulty, or any alteration that produces a modified recipe — do NOT answer, explain, or list ingredients. Reply with EXACTLY one line and nothing else:",
